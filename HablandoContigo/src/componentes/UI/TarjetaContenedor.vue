<!--
  ...
  ¿PARA QUÉ SIRVE?
  - Proveer un marco uniforme y estético a todos los módulos y preguntas,
    evitando duplicar estilos CSS de bordes, sombras y esquinas.
  
  ¿DÓNDE SE USA Y CON QUÉ ARCHIVOS SE CONECTA?
  - EncuestaPreguntaItem.vue y ResponderEncuestaView.vue.
  - DashboardColaboradorAnonimo.vue.
  - HeroPrincipal.vue (tarjetas flotantes de métricas).
  - Modales informativos del sistema.
-->
